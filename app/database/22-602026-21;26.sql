...
--
-- Host: db
-- Gegenereerd op: 22 jun 2026 om 19:25
-- Serverversie: 8.4.8
-- PHP-versie: 8.3.30
...
(7, 1, 'Jan', 'jan.jansen@example.com', 'Hoi, ik heb een vraag over de boeking voor Lowlands Festival. Kan ik mijn ticket nog omzetten naar een ander dagdeel?'),
(8, 1, 'Jan', 'jan.jansen@example.com', 'Bedankt voor de snelle bevestiging van mijn boeking! Weten jullie ook of er camperplekken beschikbaar zijn?'),
(9, 2, 'Piet', 'piet.devries@example.com', 'Goedendag, ik heb mijn boeking voor Pinkpop Landgraaf gedaan maar nog geen bevestigingsmail ontvangen. Kunnen jullie dit checken?'),
(10, 2, 'Piet', 'piet.devries@example.com', 'Is het mogelijk om met meerdere personen tegelijk in te checken bij Rock Werchter, of moet iedereen apart langs de balie?'),
(11, 3, 'Sanne', 'sanne.bakker@example.com', 'Hallo, ik wil graag weten of mijn boeking voor Down The Rabbit Hole is doorgegaan, ik zie hem nog als in behandeling staan.'),
(12, 3, 'Sanne', 'sanne.bakker@example.com', 'Super enthousiast voor Glastonbury Festival dit jaar! Is er nog informatie over het vervoer vanaf Nederland?'),
(13, 4, 'Lisa', 'lisa.mulder@example.com', 'Beste team, kan ik mijn boeking voor Primavera Sound nog wijzigen naar een ander aantal personen?'),
(14, 4, 'Lisa', 'lisa.mulder@example.com', 'Ik heb een betaling gedaan voor Coachella maar zie deze nog niet terug in mijn account. Kunnen jullie dit nakijken?');
...
(27, 1, 3, 'Bevestigd'),
(28, 1, 5, 'in behandeling'),
(29, 2, 4, 'Bevestigd'),
(30, 2, 6, 'in behandeling'),
(31, 3, 5, 'in behandeling'),
(32, 3, 7, 'Bevestigd'),
(33, 4, 8, 'Bevestigd'),
(34, 4, 10, 'in behandeling'),
(35, 1, 3, 'in behandeling');
...
(2, 'Piet', 'de Vries', 'piet.devries@example.com', '123', 'user'),
...
(19, 'wim', 'fokker', 'wim@gmail.com', '1234', 'user');
...
CREATE TABLE `wachtwoordvergeten` (
  ...
  `verloopdatum` timestamp NULL DEFAULT CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='dit zijn voor wachtwoord vergeten';

--
-- Gegevens worden geëxporteerd voor tabel `wachtwoordvergeten`
--

INSERT INTO `wachtwoordvergeten` (`id`, `email`, `code`, `verloopdatum`) VALUES
(5, 'wim@gmail.com', '1750329', '2026-06-22 18:38:29'),
(6, 'jan.jansen@example.com', '4782969', '2026-06-22 19:17:06'),
(7, 'piet.devries@example.com', '448000', '2026-06-22 20:24:00');
